...
public class Ex03List {
    ...
    public static void main(String[] args) {
		List<Integer> list1 =Arrays.asList(7,3,5,1);  //size 6
		List<Integer> list2 =Arrays.asList(3,2,3,5,0,2); //size 4 
		
		List<Integer >merge1 = merge1(list1,list2);
		System.out.println(merge1); //출력:7,3,3,2,5,3,1,5, 나머지 0,2
		
		List<Integer> merge2 = merge2(list1,list2);
		System.out.println(merge2); //거꾸로출력되게 1,2,5,0,3,5,7,3,2,3
